...
MIMEDB <- 
  read_csv("2_data/20_MIMEDB/mimedb_metabolites_v1.csv")

# Define keywords for each category
keywords <- list(
  human = c("human", "endogenous", "body", "urine", "blood"),
  ...
  plant = c("plant"),
  animal = c("animal", "cow", "milk", "meat", "livestock", "fish"),
...
save(MIMEDB_database, file = "MIMEDB_database3.rda")
